...
public class HomeController {
    ...
    private static final AuthService authService = new AuthService(clientRepository);
    private static final ClientService clientService = new ClientService(clientRepository, authService);
